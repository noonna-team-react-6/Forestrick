...
export default function UiGuidePage() {
  ...
  return (
    ...
    >
      ...
      {section === "input" ? (
        <>
          <p style={labelStyle}>Input / width</p>
          <div className="input-guide-stack">
            <Input width="short" placeholder="short (200)" />
            <Input width="medium" placeholder="medium (320, 기본값)" />
            <Input width="wide" placeholder="wide (480)" />
            <Input width="full" placeholder="full (100%)" />
          </div>

          <p style={labelStyle}>Input / label</p>
          <div className="input-guide-stack">
            <Input width="medium" label="고인 성함" placeholder="홍길동" />
            <Input width="medium" label="발인" placeholder="2026.09.07" />
          </div>

          <p style={labelStyle}>Input / children (앞 아이콘)</p>
          <div className="input-guide-stack">
            <Input width="medium" placeholder="문서와 업무 검색">
              <Icons.IconSearch />
            </Input>
            <Input width="medium" label="일정" placeholder="날짜를 입력하세요">
              <Icons.IconCalendar />
            </Input>
          </div>

          <p style={labelStyle}>Input / multiline</p>
          <div className="input-guide-stack">
            <Input
              width="wide"
              multiline
              minRows={4}
              placeholder="어떤 문서를 만들까요?"
            />
          </div>

          <p style={labelStyle}>Input / disabled</p>
          <div className="input-guide-stack">
            <Input width="medium" placeholder="비활성" disabled />
            <Input
              width="medium"
              label="부서명"
              placeholder="총무팀"
